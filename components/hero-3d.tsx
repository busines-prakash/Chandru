  ...
  return (
    ...
    >
      <div className="max-w-xl mx-auto">
        <h1 className="text-6xl font-extrabold tracking-tight text-white">Chandru S</h1>
        <p className="mt-2 text-2xl text-sky-300">UAV System Engineer</p>
      </div>
    </Html>
  );
}
  ...
  return (
    <div className="w-full h-screen relative overflow-hidden bg-gradient-to-b from-slate-900 via-blue-900 to-slate-900">
      <Canvas shadows dpr={[1, 2]} performance={{ current: 1 }}>
        <PerspectiveCamera makeDefault position={[0, 0, 3.2]} fov={54} />
